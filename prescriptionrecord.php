...
if(isset($_POST['submit'])) {
    if(isset($_GET['editid'])) {
        ...
        if($qsql = mysqli_query($con, $sql)) {
            echo "<script>alert('Enregistrement de prescription mis à jour avec succès.');</script>";
        } else {
        ...
        if($qsql = mysqli_query($con, $sql)) {
            ...
            $billtype = "Mise à jour de prescription";
            $prescriptionid = $_POST['prescriptionid'];
            include("insertbillingrecord.php");
            echo "<script>alert('Enregistrement de prescription inséré avec succès.');</script>";
...
<div class="container-fluid">
    ...
    <div class="block-header"><h2>Voir l'enregistrement de la prescription</h2></div>
    ...
    <div class="card" style="padding:10px">
        <table class="table table-hover table-striped">
            ...
            <tr>
                <th colspan="5" align="right">Total en taxe</th>
                <th align="right">$<?php echo $gtotal * 0.14; ?></th>
            </tr>
            <tr>
                <th colspan="5" align="right">Total avec taxe</th>
                <th align="right">$<?php echo $gtotal * 1.14; ?></th>
            </tr>
            </tbody>
        </table>
    </div>
