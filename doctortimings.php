...
if(isset($_POST['submit']))
{
    if(isset($_GET['editid']))
    {
        ...
        {
            echo "<script>alert('L\'enregistrement des horaires du médecin a été mis à jour avec succès...');</script>";
        }
        else
        {
    ...
    else
    {
        ...
        if($qsql = mysqli_query($con,$sql))
        {
            echo "<script>alert('L\'enregistrement des horaires du médecin a été ajouté avec succès...');</script>";
        }
        else
        {
            echo mysqli_error($con);
...
<div class="container-fluid">
    <div class="block-header">
        <h2 class="text-center">Ajouter les horaires du médecin</h2>
    </div>
    <div class="card">
        <form method="post" action="" name="frmdocttimings" onSubmit="return validateform()">
            <table class="table table-hover">
                ...
                else
                {
                    ?>
                    <tr>
                        <td width="34%" height="36">Médecin</td>
                        <td width="66%">
...
<script type="application/javascript">
    function validateform()
    {
        ...
        {
            alert("L'heure de début ne doit pas être vide..");
            document.frmdocttimings.ftime.focus();
            return false;
        }
        else if(document.frmdocttimings.ttime.value == "")
        {
            alert("L'heure de fin ne doit pas être vide..");
