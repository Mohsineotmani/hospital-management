...
if(isset($_POST['submit']))
{
    if(isset($_GET['editid']))
    {
        ...
        if($qsql = mysqli_query($con,$sql))
        {
            ...
            echo "<script>alert('L\'enregistrement du rendez-vous a été mis à jour avec succès...');</script>";
    ...
    else
    {
        ...
        if($qsql = mysqli_query($con,$sql))
        {
            echo "<script>alert('L\'enregistrement du rendez-vous a été inséré avec succès...');</script>";
        }
        else
        {
            echo mysqli_error($con);
...
<div class="card ">
    ...
    <div class="block-header">
        <h2 class="text-center">Processus d'Approbation de Rendez-vous</h2>
    </div>
            ...
            <tr>
                ...
                <td >
                    ...
                    if(isset($_GET['patientid']))
                    {
                        ...
                        echo $rspatient['patientname'] . " (ID Patient - $rspatient[patientid])";
                    }
                    else
                    {
                        ...
                        while($rspatient=mysqli_fetch_array($qsqlpatient))
                        {
                            ...
                            {
                                echo "<option value='$rspatient[patientid]' selected> $rspatient[patientname] (ID Patient - $rspatient[patientid])</option>";
                            }
                        }
                    }
                    ?>
