...
<aside class="sidebar-left" style="width: 200px;">
    ...
    <div class="sidebar-links">
        <a class="link-blue" href="javascript:patient_pg(1,<?=$pid?>);"><i class="fa fa-keyboard-o"></i>Ajouter un rendez-vous</a>
        <a class="link-red" href="viewappointment.php"><i class="fa fa-keyboard-o"></i>Voir les rendez-vous</a>
        <a class="link-yellow selected" href="patient_profile.php"><i class="fa fa-keyboard-o"></i>Voir le profil</a>
        <a class="link-green" href="logout.php"><i class="fa fa-map-marker"></i>Se déconnecter</a>
    </div>
</aside>

<div class="w3ls-banner">
    <div class="heading">
        <h1>Prendre un rendez-vous avec mon médecin</h1>
    </div>
        ...
        <div class="menu">
            <div id="show_login">
                <div class="container" style="width: 918px; margin-top: -121px;">
                    <div class="heading">
                        <h2>Veuillez entrer les détails du patient</h2>
                        <p>Remplissez le formulaire ci-dessous et soumettez votre demande. Nous vous contacterons dès que possible.</p>
                    </div>
                    ...
                    <div class="agile-form">
                        <form action="" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                    <label class="form-label" style="align:left;">Nom complet
                                ...
                                <br/>
                                <div class="col-md-12">
                                    <label class="form-label" style="align:left;">Date de naissance
                                        <span class="form-required"> * </span>
                                    </label>
                                ...
                                <br/>
                                <div class="col-md-12">
                                    <label class="form-label" style="align:left;">Adresse
                                        <span class="form-required"> * </span>
                                    </label>
...
<div class="copyright">
    <p>© 2024 Formulaire Appoint My Doctor. Tous droits réservés | Design par <a href="www.w3layouts.com">W3layouts</a></p>
</div>
