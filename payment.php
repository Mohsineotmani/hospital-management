...
if(isset($_POST['submit']))
{
    $sql = "INSERT INTO payment(patientid,appointmentid,paiddate,paidtime,paidamount,status) 
            values('$_GET[patientid]','$_GET[appointmentid]','$_POST[date]','$_POST[time]','$_POST[paidamount]','Active')";
    ...
    if($_POST['discountamount'] != '0')
    {
        $sql = "UPDATE billing SET discount=$_POST[discountamount] + discount, 
                discountreason=CONCAT('$_POST[discountreason] , ', discountreason) WHERE appointmentid='$_GET[appointmentid]'";
...
<div class="wrapper col2">
    <div id="breadcrumb">
        <ul>
            <li class="first">Détails du paiement</li>
        </ul>
    </div>
</div>
