...
if(isset($_SESSION['doctorid']))
{
    ...
    <table>
        <tr>
            <td>
                <div align="center"><a href="prescription.php?patientid=<?php echo $_GET['patientid']; ?>&appid=<?php echo $rsappointment['appointmentid']; ?>">Ajouter des enregistrements de prescription</a></div>
            </td>
        </tr>
    </table>
    <?php
